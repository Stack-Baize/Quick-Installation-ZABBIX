...
change_font_to_chinese() {
  ...
  if [ -e "simkai.ttf" ]; then
    cp simkai.ttf /usr/share/zabbix/ui/assets/fonts
    rm -f /usr/share/zabbix/ui/assets/fonts/graphfont.ttf
    ln -s /usr/share/zabbix/ui/assets/fonts/simkai.ttf /usr/share/zabbix/ui/assets/fonts/graphfont.ttf
  else
