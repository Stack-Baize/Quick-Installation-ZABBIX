...
3. **zabbix7 离线安装包制作脚本** 已支持 **centos 9 / centos 10 / rocky linux 8 / rocky linux 9 / rocky linux 10 / ubuntu 22.04 / ubuntu 24.04**
4. **zabbix7.4.sh** 已支持 **centos 8(强烈不推荐) / centos 9 / centos 10 / rocky linux 8 / rocky linux 9 / rocky linux 10 / ubuntu 22.04 / ubuntu 24.04 / debian 12 / almaLinux 8 / almaLinux 9 / almaLinux 10**
5. docker 部署已完成测试系统 **rocky linux 9 / ubuntu 24.04**
6. **openeuler.sh** 已支持 **openeuler 22.03 / openeuler 24.03**
7. 加入QQ群获取**centos7安装zabbix7脚本**
